...
if (isset($_POST['sellerid']) && isset($_POST['orderbill'])) {
    ...
    $sqlorderdetails = "SELECT * FROM `tbl_orders` INNER JOIN `tbl_items` ON tbl_orders.item_id = tbl_items.item_id WHERE tbl_orders.seller_id = '$sellerid' AND tbl_orders.order_bill = '$orderbill'";
}
